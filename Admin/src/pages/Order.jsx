...
const HeroStats = ({ stats }) => (
  ...
  >
    ...
    <div className="relative grid grid-cols-2 lg:grid-cols-4 divide-x divide-white/[0.07] [&>*:nth-child(n+3)]:border-t [&>*:nth-child(n+3)]:border-white/[0.07] lg:[&>*:nth-child(n+3)]:border-t-0">
      {[
        {
          label: "Gross Revenue",
        ...
        },
        {
          ...
          sub: stats.total
            ? `${Math.round((stats.delivered / stats.total) * 100)}% success`
            : "—",
        ...
        <motion.div
          ...
          className={`px-4 py-5 lg:px-6 lg:py-8
            ${i % 2 === 0 ? "border-r border-white/[0.07]" : ""}
            ${i < 2 ? "border-b border-white/[0.07]" : ""}
            lg:border-b-0 lg:border-r lg:last:border-r-0`}
        >
          <p
            className="text-[9px] font-bold tracking-[0.25em] uppercase text-white/30 mb-3"
            style={{ fontFamily: "'JetBrains Mono', monospace" }}
          >
            {label}
          </p>
          <p
            className={`text-[clamp(1.1rem,4vw,2.4rem)] font-extrabold leading-none tracking-tight ${color}`}
            ...
            <div className="flex flex-col items-center gap-1 flex-shrink-0">
              <div
                ...
                ${
                    ...
                    : active
                      ? `${stepCfg.left} border-transparent shadow-lg ${cfg.glow}`
          ...
          <div className="p-5 lg:p-6">
            <div className="grid grid-cols-1 lg:grid-cols-[1fr_auto_auto] gap-5 lg:gap-8 items-start">
                ...
                <div className="flex items-start justify-between gap-3">
                  <div>
                    <div className="flex items-center gap-2.5 mb-1.5">
                      <span
                        className={`inline-flex items-center gap-1.5 text-[10px] font-bold tracking-[0.15em] uppercase px-2.5 py-1 rounded-lg ${cfg.pill}`}
                        style={{ fontFamily: "'JetBrains Mono', monospace" }}
                      >
                        <span
                          className={`w-1.5 h-1.5 rounded-full ${cfg.dot} ${order.status !== "Delivered" ? "animate-pulse" : ""}`}
                        />
                        {cfg.label}
                      </span>
                      {order.payment && (
                        <span
                          className="inline-flex items-center gap-1 text-[9px] font-bold px-2 py-0.5 rounded-md bg-emerald-50 text-emerald-600 ring-1 ring-emerald-200"
                          style={{ fontFamily: "'JetBrains Mono', monospace" }}
                        >
                    ...
                    <h3
                      className="font-bold text-slate-900 text-[16px] leading-tight"
                      style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}
                    >
              ...
              <div className="hidden lg:flex flex-col items-end justify-start gap-1 pt-1 min-w-[100px]">
                ...
                <p
                  className="text-[1.7rem] font-extrabold text-slate-900 tracking-tight leading-none"
                  style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}
                >
                  {fmt(order.amount)}
                </p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 p-5 lg:p-6">
                  ...
                  <div className="bg-slate-50 rounded-xl border border-slate-100 p-4">
                    <div className="flex items-center justify-between mb-3">
                      ...
                      <span
                        className="text-[9px] font-bold bg-slate-200 text-slate-600 px-2 py-0.5 rounded-full"
                        style={{ fontFamily: "'JetBrains Mono', monospace" }}
                      >
                        {itemCount} {itemCount === 1 ? "item" : "items"}
                      </span>
                      ...
                      {order.items?.map((item, idx) => (
                        <div key={idx}>
                          ...
                          <div className="flex items-center gap-3 md:hidden">
                            {item.image && (
                              <div className="w-12 h-12 rounded-xl border border-slate-200 overflow-hidden bg-slate-50 flex-shrink-0">
                                <img
                                  src={
                          ...
                          <div className="hidden md:flex items-center justify-between">
                            <div className="flex items-center gap-3">
                              <span
                                className="w-6 h-6 rounded-md bg-white border border-slate-200 flex items-center justify-center text-[10px] font-bold text-slate-600 shadow-sm flex-shrink-0"
                                style={{
                                  fontFamily: "'JetBrains Mono', monospace",
                                }}
                              >
                  ...
                  <div className="bg-slate-50 rounded-xl border border-slate-100 p-4">
                    <p
                      className="text-[9px] font-bold tracking-[0.2em] uppercase text-slate-400 mb-3"
                      style={{ fontFamily: "'JetBrains Mono', monospace" }}
                    >
                      Delivery Address
                    </p>
                    <div className="space-y-1 text-[13px] text-slate-600 leading-relaxed">
                      ...
                      <p
                        className="font-medium mt-2 pt-2 border-t border-slate-200"
                        style={{
                          fontFamily: "'JetBrains Mono', monospace",
                          fontSize: "11px",
                        }}
      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-8 py-8">
        ...
        >
          ...
          <p className="text-[13px] text-slate-400 mt-1.5 font-medium">
            {orders.length} total orders · {stats.active} active ·{" "}
