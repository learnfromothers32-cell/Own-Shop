...
const sectionVariants = {
  ...
  visible: (d = 0) => ({ opacity: 1, y: 0, transition: { duration: 0.5, delay: d, ease: [0.33, 1, 0.68, 1] } }),
};
    ...
    >
      ...
      >
        ...
        <h1 className="text-2xl sm:text-3xl font-black text-[#1a1a1a] tracking-tight">
          Add <span className="text-gray-400 font-medium">Product</span>
        </h1>
      </motion.div>
      ...
      >
        ...
        <div className="flex gap-3 flex-wrap">
          {images.map(({ state, setter, id }, i) => (
            ...
            >
              <div className={`w-20 h-20 rounded-xl overflow-hidden border-2 transition-all duration-200 flex items-center justify-center
              ...
              >
                {state ? (
                  ...
                  <div className="flex flex-col items-center gap-1 text-gray-300 group-hover:text-gray-400 transition-colors">
                    {Icons.upload}
                    <span className="text-[9px] font-semibold tracking-wide uppercase">{i + 1}</span>
                  </div>
                )}
              </div>
      ...
      {/* ── Product details ── */}
      <motion.div
        variants={sectionVariants} custom={0.1}
        initial="hidden" animate="visible"
      ...
      >
        ...
        <div className="flex flex-col gap-1.5">
          <span className="text-[10px] font-bold tracking-[0.25em] uppercase text-gray-400">Description</span>
          <textarea
            rows={3}
      ...
      {/* ── Category + price ── */}
      <motion.div
        variants={sectionVariants} custom={0.15}
        initial="hidden" animate="visible"
        className="p-5 border border-gray-100 rounded-2xl bg-gray-50/50 flex flex-col gap-4"
      >
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          ...
          <div className="flex flex-col gap-1.5 flex-1">
            <span className="text-[10px] font-bold tracking-[0.25em] uppercase text-gray-400">Category</span>
            <select
          ...
          {/* Sub category */}
          <div className="flex flex-col gap-1.5 flex-1">
            <span className="text-[10px] font-bold tracking-[0.25em] uppercase text-gray-400">Sub Category</span>
            <select
      ...
      {/* ── Sizes ── */}
      <motion.div
        variants={sectionVariants} custom={0.2}
        initial="hidden" animate="visible"
        className="p-5 border border-gray-100 rounded-2xl bg-gray-50/50"
      >
        <SectionHeader eyebrow="Available Sizes" icon={Icons.grid} />
        ...
        <AnimatePresence>
          {sizes.length > 0 && (
            ...
            >
              Selected: <span className="font-semibold text-gray-600">{sizes.join(", ")}</span>
            </motion.p>
          )}
        </AnimatePresence>
      </motion.div>
      ...
      {/* ── Bestseller toggle ── */}
      <motion.div
        variants={sectionVariants} custom={0.25}
        initial="hidden" animate="visible"
      ...
      >
        ...
        >
          ...
          <div>
            <p className="text-sm font-semibold text-gray-700">Add to Bestsellers</p>
            <p className="text-[10px] text-gray-400 tracking-wide">Featured on the homepage bestseller section</p>
          </div>
        </motion.label>
      </motion.div>
      ...
      {/* ── Submit ── */}
      <motion.div
        variants={sectionVariants} custom={0.3}
        initial="hidden" animate="visible"
      ...
      >
        <motion.button
          ...
          whileHover={!isSubmitting ? { scale: 1.02, backgroundColor: "#333" } : {}}
        ...
        <p className="flex items-center justify-center gap-1.5 text-[10px] text-gray-400 tracking-wide">
          Product will be listed in the store immediately after publishing.
        </p>
      </motion.div>
